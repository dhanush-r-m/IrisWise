...
# Developer Tag with GitHub link and icon
st.markdown("""
<div class="developer-tag">
    <strong>👨‍💻 Developer: Dhanush Moolemane</strong>
    <a href="https://github.com/dhanush-r-m" target="_blank">
        <img class="github-icon" src="https://cdn-icons-png.flaticon.com/512/25/25231.png">
    </a>
</div>
""", unsafe_allow_html=True)
